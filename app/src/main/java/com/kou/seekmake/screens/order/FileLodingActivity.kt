            ...
            vm.uploadFile(body).observe(this, Observer { fileResponse ->
                ...
                if (fileResponse.URL == "0") {
                    ...
                    btn_next.setOnClickListener {
                        ...
                        vm.submitOrder(PrefsManager.geToken(this)!!, Order(mClient.address, mClient.city, mClient._id, "https://seekmake.com:3000/" + fileResponse.URL, mClient.firstname, mClient.lastname, mClient.tel, technique, "normal", mClient.zip, epaisseur_input.text.toString(), chosenMaterial, qty, resolution_input.text.toString(), true, "livraision a domicil")).observe(this, Observer { orderResponse ->
